...
// 市集頁面：從市集裝的使用者由 VS Code 自動更新，只會被導到這裡，不提供 VSIX 直裝
const MARKETPLACE_PAGE = 'https://marketplace.visualstudio.com/items?itemName=LaiYueJi.claude-code-zh';
...
module.exports = { Updater, RELEASE_PAGE, MARKETPLACE_PAGE, DEFAULT_SOURCES };
